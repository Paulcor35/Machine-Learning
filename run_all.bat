...
py main.py -f data/Carseats_prepared.csv -s %ARG% -t c -F High -a DecisionTree
py main.py -f data/ozone_complet.txt -s %ARG% -t r -F maxO3 -a RandomForest
py main.py -f data/Carseats_prepared.csv -s %ARG% -t c -F High -a RandomForest
...
py main.py -f data/Carseats_prepared.csv -s %ARG% -t c -F High -a SVM
